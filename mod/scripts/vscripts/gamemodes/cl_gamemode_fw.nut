...
{
	print( "camptrakcer owner : " + ent.GetOwner() )
	if ( ent.GetOwner() != null )
	{
		print( "CLIENT FW_OnLocationTrackerCreated triggered " )
...
{
	print( "Basetrakcer owner : " + tracker.GetOwner() )
	if ( tracker.GetOwner() != null )
	{
		print( "CLIENT FW_OnBaseCreated triggered " )
